...
# Define Presets
PRESETS = {
    "build-remote-{service}": {"operation": "build", "platform": "amd", "service": "{service}"},
    "deploy-remote-{service}": {"operation": "deploy", "platform": "amd", "service": "{service}"},
}
...
def handle_preset_flow(preset_keys: List[str], choice: str) -> Tuple[str, str, List[str]]:
